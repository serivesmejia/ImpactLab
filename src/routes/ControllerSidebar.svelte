    ...
    <div class="sidebar-inner overflow-y-auto flex-1 flex flex-col">
      ...
      <div class="space-y-4 flex-1">
        ...
        <div>
          ...
          <input type="number" class="w-full p-2 rounded text-black" step="0.0001" min="-90" max="90" />
        </div>
        <div>
          <label class="block mb-1">Longitude (°)</label>
          <input type="number" class="w-full p-2 rounded text-black" step="0.0001" min="-180" max="180" />
        </div>

        <div class="time">
          <label for="time-scale">
            Time Scale: {controls.daysPerSec} days/second
          </label>
          <input
            id="time-scale"
            type="range"
            ...
            max="5"
            step="0.05"
            bind:value={controls.daysPerSec}
            class="w-full"
          />
        </div>
        ...
        <div class="mt-4">
          ...
          >
            {controls.shooting ? "Shooting" : "Ready to Shoot"}
          </button>
        </div>
      </div>
    </div>
